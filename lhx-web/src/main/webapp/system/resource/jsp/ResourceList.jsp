...
<body style="width:99%;">
		...
		<table  id="resourceList" title="用户列表" data-options="rownumbers:true,singleSelect:true,iconCls:'icon-ok'" style="height:250px"   dataurl="<%=basePath%>system/resourceManager/ajaxlist.do" >
		</table>
